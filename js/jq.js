...
$(document).ready(function() {
  ...
  $("#add2Room").click(function() {
    ...
    if (addToCount < 1) {
      ...
      newTextBoxDiv.after().html('<form action="<?php echo $_SERVER[\'PHP_SELF\']; ?>" method="post"> <input type="text" name="nameTextbox" id="nameTextbox" placeholder="Name" style="width:30%" size="25" maxlength="40"> <select name="bedTextbox" id="bedTextbox" placeholder="Bed Letter" style="width:12%"><option>Bed</option><option>A</option><option>B</option><option>C</option><option>D</option></select> <select name="buildingTextbox" id="buildingTextbox" style="width:20%"><option>Building</option><option>The Complex</option><option>Brunswick</option><option>Carroll</option><option>Dickenson</option><option>Essex</option><option>Franklin</option><option>Grayson</option><option>Adams</option><option>Harrison</option><option>Jackson</option><option>Jefferson</option><option>Kennedy</option><option>Lincoln</option><option>Madison</option><option>Monroe</option><option>Roosevelt</option><option>Truman</option><option>Washington</option><option>Wilson</option><option>Dominion</option><option>Commonwealth</option></select><select name="floorTextbox" id="floorTextbox" style="width:12%"><option>1</option><option>2</option><option>3</option></select></form>');
